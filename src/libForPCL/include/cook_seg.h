...
int ExtractClusters(pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud_in,std::vector<pcl::PointCloud<pcl::PointXYZ>::Ptr>& clusters,float tolerance,int max_size=25000,int min_size=100);
